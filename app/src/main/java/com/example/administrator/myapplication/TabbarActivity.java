...
import com.com.util.SizeHelper;
...
public class TabbarActivity extends Activity {
    ...
    private void initGroup() {
        ...
        myRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                rb.setBackgroundResource(R.color.drak_green);
                ColorStateList csl = getResources().getColorStateList(R.color.white);
                rb.setTextColor(csl);
    ...
    public void reSet(){
        for(int i=0;i<myRadioGroup.getChildCount();i++){
            RadioButton rb = (RadioButton)myRadioGroup.getChildAt(i);
